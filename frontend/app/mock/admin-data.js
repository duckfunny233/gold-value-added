...
export const usersData = {
  ...
  relatedRecords: {
    recharge: ['充值订单 re_20260405001', '充值流水 trc_dep_5521'],
    withdraw: ['提现单 wd_20260405003', '审核日志 trc_wd_1203'],
    trade: ['交易单 tr_9031', '同步记录 trc_chain_7712'],
    audit: ['审计轨迹 evt_001', '哈希校验通过'],
  },
}
...
export const fundsData = {
  ...
  withdrawRows: [
    { orderId: 'wd_20260405003', uid: 'U0001089', nickname: '金影子089', channel: '银行卡', amount: '¥5,000', status: '待审核', createdAt: '09:23:45', paidStatus: '待打款', payout: '招商银行 6225 **** 2881' },
    { orderId: 'wd_20260405006', uid: 'U0001136', nickname: '金影子136', channel: '支付宝', amount: '¥1,800', status: '已通过', createdAt: '09:29:20', paidStatus: '待确认', payout: '支付宝收款码已上传' },
  ],
  ledgerRows: [
