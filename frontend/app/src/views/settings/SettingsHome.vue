...
import { ArrowLeft, ShieldCheck, UserRoundCog, SlidersHorizontal, LifeBuoy, Info } from 'lucide-vue-next'
      ...
      <div class="border-y border-[#2b3b4c] bg-[#162331]">
        ...
        >
          ...
          <div class="min-w-0 flex-1">
            <p class="text-sm font-bold text-[#ecf2f9]">{{ item.title }}</p>
            <p class="mt-1 truncate text-xs text-[#8e9bb0]">{{ item.desc }}</p>
          </div>
        </button>
      </div>
    </div>
